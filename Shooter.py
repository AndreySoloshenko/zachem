...
background = transform.scale(image.load("pole.jpg"),(w_width,w_height))
#-----
...
game = True
#-----
hero = Player("p2.png",10,400,60,60,16)
#-----
monsters = sprite.Group() #монстри - група спрайтів
for i in range(1,7):
    monster = Enemy("p1.png",randint(80,400),-40,60,60,randint(1,5))
    monsters.add(monster)
#-----
lose = font2.render("Ви програли!",1,(0,0,0))
victory = font2.render("Ви виграли!",1,(0,0,0))
#-----
while game:
    for event1 in event.get():
        if event1.type == pygame.QUIT:
            ...
            if event1.key == K_SPACE: #Постріл
                hero.fire()
    if not finish:
        window.blit(background,(0,0))
        text1=font2.render("РАХУНОК: "+str(score),1,(0,0,0))
        window.blit(text1,(50,50))
        text2=font2.render("ПРОПУЩЕНО:"+str(lost),1,(0,0,0))
        window.blit(text2,(50,25))
        hero.control()
        bullets.update()
        monsters.update()
#-----
...
#-----
        ...
        for c in collides:
            score = score+1
            monster = Enemy("p1.png",randint(80,400),-40,60,60,2)
            monsters.add (monster)
